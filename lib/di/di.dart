...
void prepareBlocs(GetIt sl) async {
  ...
  sl.registerSingleton<HomeBloc>(HomeBloc(sl<SharedPreferenceCache>(), sl<CategoryRepository>(), sl<ProductRepository>(), sl<CategoryBloc>(), sl<ItemRepository>(), sl<ChangeRepository>()));
