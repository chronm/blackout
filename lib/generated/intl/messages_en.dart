...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "SETUP_CREATE_HOME_CARD_TITLE" : MessageLookupByLibrary.simpleMessage("What would you like to call your household? You can always change it later, of course"),
    ...
    "SETUP_USERNAME_CARD_TITLE" : MessageLookupByLibrary.simpleMessage("In order to track your actions, you need to create a username. If you do not like it later, you can change it."),
