...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m3(days) =>
      "${Intl.plural(days, zero: '', one: '1 day', other: '${days} days')}";

  static m4(months) =>
      "${Intl.plural(months, zero: '', one: 'in 1 month', other: 'in ${months} months')}";

  static m5(weeks) =>
      "${Intl.plural(weeks, zero: '', one: 'in 1 week', other: 'in ${weeks} weeks')}";
  ...
  static m9(hours) =>
      "${Intl.plural(hours, zero: '', one: '1 hour', other: '${hours} hours')}";

  static m10(amount) => "Less than ${amount} available";

  static m11(minutes) =>
      "${Intl.plural(minutes, zero: '', one: '1 minute', other: '${minutes} minutes')}";

  static m12(months) =>
      "${Intl.plural(months, zero: '', one: '1 month', other: '${months} months')}";

  static m13(notificationDate) => "Notify at ${notificationDate}";

  static m14(seconds) =>
      "${Intl.plural(seconds, zero: '', one: '1 second', other: '${seconds} seconds')}";

  static m15(weeks) =>
      "${Intl.plural(weeks, zero: '', one: '1 week', other: '${weeks} weeks')}";

  static m16(years) =>
      "${Intl.plural(years, zero: '', one: '1 year', other: '${years} years')}";
  ...
  static _notInlinedMessages(_) => <String, Function>{
        ...
        "DIALOG_ADD_TO_CHARGE":
            MessageLookupByLibrary.simpleMessage("Add to charge"),
        "DIALOG_CANCEL_BUTTON": MessageLookupByLibrary.simpleMessage("Cancel"),
        "DIALOG_TAKE_FROM_CHARGE":
            MessageLookupByLibrary.simpleMessage("Take from charge"),
        ...
        "GENERAL_EVENT_IN_OVER_A_YEAR":
            MessageLookupByLibrary.simpleMessage("in over one year"),
        "GENERAL_EVENT_IN_WEEKS": m5,
        "GENERAL_EVENT_OVER_A_YEAR_AGO":
            MessageLookupByLibrary.simpleMessage("over one year ago"),
        ...
        "GENERAL_YEARS": m16,
        "GROUP_BEST_BEFORE":
            MessageLookupByLibrary.simpleMessage("Warn me before expiration"),
        ...
        "GROUP_NAME":
            MessageLookupByLibrary.simpleMessage("Name of this group"),
        "GROUP_PLURAL_NAME":
            MessageLookupByLibrary.simpleMessage("Plural form of name"),
        ...
        "HOME_PRODUCTS_AND_GROUPS":
            MessageLookupByLibrary.simpleMessage("Products and Groups"),
        ...
        "PERMISSIONS_STORAGE_PERMANENTLY_TITLE":
            MessageLookupByLibrary.simpleMessage("Access to storage"),
        ...
        "SETUP_HOME_NAME":
            MessageLookupByLibrary.simpleMessage("Name of your household"),
        ...
        "SPEEDDIAL_CREATE_CHARGE":
            MessageLookupByLibrary.simpleMessage("Create charge"),
        ...
        "SPEEDDIAL_TAKE_FROM_CHARGE":
            MessageLookupByLibrary.simpleMessage("Take"),
        ...
        "UNIT_EXPIRATION_DATE":
            MessageLookupByLibrary.simpleMessage("Best before"),
        "UNIT_NOTIFICATION_DATE":
            MessageLookupByLibrary.simpleMessage("Notify at"),
        ...
        "WARN_PERIOD_MUST_NOT_BE_EMPTY":
            MessageLookupByLibrary.simpleMessage("Period must not be empty"),
        ...
        "WARN_USERNAME_MUST_NOT_BE_EMPTY":
